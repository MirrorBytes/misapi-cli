    ...
    for(var fieldsLength = fields.length;fieldsLength--;) {
      ...
      if(fields[fieldsLength].type === 'Array') {
        ...
        if(fields[fieldsLength].options) {
          fields[fieldsLength].options = JSON.parse(fields[fieldsLength].options);
          fields[fieldsLength].options = Object.assign({}, fields[fieldsLength].options, { type: 'mongoose.Schema.Types.' + fields[fieldsLength].type });
          model += JSON.stringify(fields[fieldsLength].options);
        } else {
